...
| 이름   | 역할                                         | url                          |
| ------ | -------------------------------------------- | ----------------------------- |
| 양소은 | 팀장, 논문 요약 리뷰 및 발표, 데이터 전처리(토큰화, 불용어처리), LDA토픽모델링, FVE 계산, FPE 계산, 대시보드 제작             | https://github.com/Sunnn-y |
| 손효정 | 팀원, 뉴스데이터 수집, 5년치 데이터 병합, 병렬처리, LASSO 회귀 분석, 토픽별 예측거래량 시각화, FPE 계산 추천시스템 구현, 최종 발표             | https://github.com/sonhj110 |
