...
def get_news_value(d, k, s) :
  ...
  file = open(f"/content/drive/MyDrive/SK하이닉스/뉴스 크롤링 데이터/20.4월/sk_{str(now.strftime('%y%m%d'))}.csv",mode="w",encoding="utf-8",newline="")
...
get_news_list('SK하이닉스', 'yyyy.mm.dd', 'yyyy.mm.dd') # (키워드, startdate, enddate)
